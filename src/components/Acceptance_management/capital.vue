        ...
        <div class="d2">
            <div class="btnd1">
                <el-row>
                    ...
                    <el-button @click="pwd">归档</el-button>
            ...
            <div class="bd1">
                <template>
                    <el-table :data="tableData" :cell-style='cellStyle' :header-cell-style='rowClass' border
                        ...
                        <el-table-column prop="zhu" label="实际投资" >
                        </el-table-column>

                        <el-table-column prop="ztz" label="验收日期" >
                        </el-table-column>
                        <el-table-column prop="bm" label="验收批复" >
                        </el-table-column>
                        ...
                        <el-table-column label="操作" >
                            ...
                            <el-row>
                                ...
                                <el-button type="primary" size="mini">验收</el-button>
