            ...
            <div class="bd1">
                <template>
                    <el-table :data="tableData" :cell-style='cellStyle' :header-cell-style='rowClass' border
                        ...
                        <el-table-column prop="date" label="报告类型" >
                        </el-table-column>
                        <el-table-column prop="zt" label="公司名称" >
                        </el-table-column>
                        <el-table-column prop="name" label="报告文号" >
                        </el-table-column>
                        <el-table-column prop="zhu" label="报告日期" >
                        </el-table-column>

                        <el-table-column prop="ztz" label="备注" >
                        </el-table-column>
