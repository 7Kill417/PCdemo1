            ...
            <div class="bd1">
                <template>
                    <el-table :data="tableData" :cell-style='cellStyle' :header-cell-style='rowClass' border
                        ...
                        <el-table-column prop="zt" label="发文单位" >
                        </el-table-column>
                        <el-table-column prop="name" label="文件标题" >
                        </el-table-column>
                        <el-table-column prop="zhu" label="文件号" >
                        </el-table-column>

                        <el-table-column prop="ztz" label="发文日期" >
                        </el-table-column>
                        <el-table-column prop="bm" label="备注" >
                        </el-table-column>
